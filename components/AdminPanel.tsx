...
const AdminPanel: React.FC = () => {
  ...
  const handleInvite = async () => {
    try {
      ...
      setInviteName(''); setInviteEmail(''); setInviteRole('visitor');
    } catch (e: any) {
      ...
      <div className="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="col-span-2">
          ...
          <div className="flex gap-2">
            <input className="p-2 border rounded w-1/3" placeholder="Name" value={inviteName} onChange={e => setInviteName(e.target.value)} />
            <input className="p-2 border rounded w-1/3" placeholder="Email" value={inviteEmail} onChange={e => setInviteEmail(e.target.value)} />
